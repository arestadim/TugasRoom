package com.example.noteappsroom.ui.insert;
...
import com.example.noteappsroom.R;
import com.example.noteappsroom.database.Note;
import com.example.noteappsroom.databinding.ActivityNoteAddUpdateBinding;
import com.example.noteappsroom.helper.DateHelper;
import com.example.noteappsroom.helper.ViewModelFactory;
...
public class NoteAddUpdateActivity extends AppCompatActivity {
    ...
    protected void showAlertDialog(int type) {
